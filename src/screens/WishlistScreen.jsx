            ...
            <List>
              ...
              <List.Item right={<View style={{ flexDirection: 'row' }}><Text></Text></View>}>
                <View style={{ flexDirection: 'row' }}>
                  <TouchableOpacity onPress={() => dispatch(removeFromWishlist(item.id))} style={{ paddingHorizontal: 12, paddingVertical: 8, borderRadius: 8, borderWidth: 1, borderColor: colors.border }}>
